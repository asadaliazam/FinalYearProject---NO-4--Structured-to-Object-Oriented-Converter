 ...
 */
public class SelectedFile extends javax.swing.JFrame implements ActionListener{
    ...
    SelectedFile(ProjectController obj, String miniFile, String outputPath) throws IOException {
        initComponents();
        this.miniFile = miniFile;
        this.outputPath = outputPath;
        projectControllerObject = obj;
        Scanner fin = new Scanner(new File(miniFile));
        String buffer = "";
        while (fin.hasNext())
        {
        buffer += fin.nextLine() +"\n";
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(10, 77, 177));
        ...
        jPanel2.setBackground(new java.awt.Color(10, 77, 177));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(SelectedFile.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void actionPerformed (ActionEvent e) 
    {
      ...
      {
          Output outputObject = new Output(projectControllerObject, miniFile, outputPath);
          outputObject.setVisible(true);
          check = 1;
          this.setVisible(false);
          //System.exit(0);
      }
      if (progressBar.getValue()==30 && check==0)
      {
          outputArea.setText("DFD Generated...");
          outputArea.append("\n");
      }
      
      if (progressBar.getValue()==60 && check==0)
      {
          outputArea.append("Data Dictionary Generated...");
          outputArea.append("\n");
      }
      if (progressBar.getValue()==90 && check==0)
      {
          outputArea.append("Class Diagram Generated...");
          outputArea.append("\n");
      }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectedFile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelectedFile().setVisible(true);
            }
        });
    }
