...
void add_student(dbs[]);
void search_student(dbs[]);
void edit_student (dbs[]);
void delete_student(dbs[]);
...
cout<<"Enter Date of Birth of course: ";cin>>ptr[0].dob.dt;cout<<endl<<"Enter month of birth: ";cin>>ptr[0].dob.month;cout<<endl<<"Enter year of birth: ";cin>>ptr[0].dob.year;cout<<endl<<"Enter id: ";cin>>ptr[0].id;cout<<endl<<"Student or employee? ";cin>>ptr[0].member;cout<<endl<<"Enter first name: ";cin>>ptr[0].name1;cout<<endl<<"Enter second name:";cin>>ptr[0].name2;
	cout<<endl<<endl;
}
...
void edit_course(course temp[])
{
	...
	if (opx==1)
	{
		...
		for (int i=0;i<10;i++)
		{
			...
			cout<<"Date of birth of course: "<<temp[i].dob.dt<<".  "<<"Month of birth of course: "<<temp[i].dob.month<<".   "<<"Year of birth of course: "<<temp[i].dob.year<<"  "<<endl;
...
break;
	...
	if (opx==2)  // search by 1st name
	{
		...
		for (int i=0;i<10;i++)
		{
			...
			{cout<<"Current detail of course is: "<<endl<<endl;cout<<"Date of birth of course: "<<temp[i].dob.dt<<".  "<<"Month of birth of course: "<<temp[i].dob.month<<".   "<<"Year of birth of course: "<<temp[i].dob.year<<"  "<<endl;
		cout<<"Membership type: "<<temp[i].member<<".    "<<"Name:  "<<temp[i].name1<<" "<<temp[i].name2;	
